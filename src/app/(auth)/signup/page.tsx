...
export default function ModernRegistrationPage() {
    ...
    return (
        <div className="bg-gray-50 flex items-center justify-center relative min-h-screen ">
            <a
                href="/"
                className="absolute top-4 right-4 sm:top-6 sm:right-6 flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors group z-50"
            >
