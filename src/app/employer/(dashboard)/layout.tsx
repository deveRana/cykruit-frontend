...
const navLinks = [
    ...
    { name: "Jobs", href: "/jobs" }, // Add more links as needed
];
                        ...
                        {navLinks.map((link) => {
                            ...
                            return (
                                <Link
                                    key={link.href}
                                    href={link.href}
                                    className={`flex items-center px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors ${isActive ? "bg-green-50 text-green-600 font-semibold shadow-sm" : ""
                                        }`}
                                >
                                    {link.name}
                                </Link>
                    ...
                    <header className="h-16 bg-white shadow-md flex items-center justify-between px-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <span className="font-medium text-gray-700">Acme HR</span>
                            </div>
                        </div>
                    </header>
