...
export default function EmployerKycPage() {
    ...
    const handleKycSuccess = (nextUrl: string) => router.push(nextUrl);
    const handleResubmit = () => refetchStatus();

    if (isStatusLoading) return <div className="min-h-screen flex items-center justify-center">Loading...</div>;
