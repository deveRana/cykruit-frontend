        ...
        <section className="relative w-full py-24 bg-[#0062FF] text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-xl mx-auto">
                    ...
                    />
                    <button className="w-full sm:w-auto px-8 py-3 bg-white text-[#0062FF] font-semibold rounded-md shadow-md hover:bg-[#0062FF] hover:text-white transition-colors">
                        Subscribe
                    </button>
                </div>
            </div>
