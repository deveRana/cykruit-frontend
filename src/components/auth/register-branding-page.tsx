...
export const RegisterBranding: React.FC<RegisterBrandingProps> = ({
    ...
    return (
        <div
            className="hidden lg:flex lg:w-1/2 lg:min-h-screen p-14 xl:p-18 flex-col relative overflow-hidden lg:sticky lg:top-0"
            style={{ backgroundColor }}
        >
            <div className="lg:h-screen flex flex-col justify-center py-12">
                {/* Decorative elements */}
