...
import { MapPin, Briefcase, Calendar, User, Share2 } from "lucide-react";
import { DetailedJob } from "@/features/jobs/types/jobSlug";
...
export default function JobHeader({ job, onApply, alreadyApplied }: JobHeaderProps) {
    const [isShareOpen, setIsShareOpen] = useState(false);

    return (
        <>
            <div className="z-10 relative flex flex-col sm:flex-row p-8 sm:p-12 rounded-2xl bg-white shadow-lg gap-6 items-start">
                {/* Job info */}
                ...
                <div className="flex gap-4 mt-4 sm:mt-0">
                    <button
                        ...
                        className={`px-6 py-3 rounded-xl text-white font-semibold shadow-lg transition transform ${alreadyApplied
                            ? "bg-gray-400 cursor-not-allowed"
                            : "bg-gradient-to-r from-blue-600 to-blue-500 hover:scale-105 hover:shadow-xl"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className="px-6 py-3 rounded-xl bg-gray-100 text-gray-800 font-semibold hover:bg-gray-200 transition flex items-center gap-2"
                    >
