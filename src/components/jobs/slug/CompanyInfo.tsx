        ...
        <div className="bg-[#F1F5F9] p-6 rounded-2xl flex flex-col md:flex-row gap-4 md:items-center">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600 text-sm">{company.industry || "Tech Company"} • {company.employees || "200"} Employees</p>
                </div>
            </div>
            <div className="flex gap-6 mt-4 md:mt-0 md:ml-auto text-gray-700">
                <div className="flex items-center gap-2"><FiGlobe className="text-[#0F123F]" /> {company.website || "www.companywebsite.com"}</div>
                <div className="flex items-center gap-2"><FiUsers className="text-[#0F123F]" /> {company.employees || "200"} Employees</div>
            </div>
        </div>
    );
};
